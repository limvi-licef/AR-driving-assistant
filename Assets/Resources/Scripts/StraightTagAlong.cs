...
namespace HoloToolkit.Unity
{
    ...
    public class StraightTagAlong : MonoBehaviour
    {
        ...
        protected virtual bool CalculateTagalongTargetPosition(Vector3 fromPosition, out Vector3 toPosition)
        {
            ...
            toPosition = cam.transform.position + cam.transform.forward * TagalongDistance;
            ...
            if (moveRight)
            {
                ...
                ray.direction = -cam.transform.right;
            }
            else if (moveLeft)
            {
            ...
            if (moveDown)
            {
                ...
                ray.direction = cam.transform.up;
            }
            else if (moveUp)
            {
            ...
            ray = new Ray(cam.transform.position, toPosition - cam.transform.position);
